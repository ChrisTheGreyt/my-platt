    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black">
        ...
        <div className='flex items-center gap-8'>
            ...
            <div className='relative flex h-min w-[200px]'>
                ...
                <input 
                    className='w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent focurs:outline-none dark:bg-gray-700 dark:text-white dark:placeholder-white' type='search' placeholder='Search...'
                />
            </div>
        </div>
        {/* Icons */}
            ...
            <div className = "hidden items-center justify-between md:flex">
                <div className='align-center flex h-9 w-9 justify-center'>
                    { !!currentUserDetails?.profilePictureUrl ? (
                        <Image
                            src = { `https://mp-s3-images.s3.us-east-1.amazonaws.com/${ currentUserDetails?.profilePictureUrl }` }
